...
## [7.1.0] - 2026-09-12 - Export Receipt

### Added
- Local `export-receipt.json` builder (`lib/export-receipt.js`): notes, skipped, write failures, attachments, formats, dry-run, include-deleted, ok flag
- Node unit tests for the receipt (no Notes.app required)

### Docs
- Infographics and landing stamps moved to **v7.1.0**
- Version file, CLI fallback, and README badge lockstep
