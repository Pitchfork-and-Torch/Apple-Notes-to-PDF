...
[![Live](https://img.shields.io/badge/docs-github.io-111111)](https://pitchfork-and-torch.github.io/Apple-Notes-to-PDF/)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)
[![macOS](https://img.shields.io/badge/macOS-12%2B-black)](https://github.com/Pitchfork-and-Torch/Apple-Notes-to-PDF)
[![Version](https://img.shields.io/badge/version-7.1.0-informational)](VERSION)
...
| Wrong version string | `cat VERSION` and `./export-apple-notes.sh --version` should both show **7.1.0** |
